...
font = ImageFont.truetype('Montserrat-Light.ttf', 12)  #Trae el formato externo
...
#Al parecer desde aqui imprime los datos capturados en el display
    ...
    draw.text((18, top),      str("hola mundo"),  font=font, fill=255)
#    draw.text((18, top),      str(IP),  font=font, fill=255)

    draw.text((3, 12), str("HOLA"), font=font_text_big, fill=255)
##Los top+12 desplazan el texto para arriba o abajo
##Los X+32 desplazan el texto a derecha o izquierda
